          ...
          SizedBox(
            ...
            child: StreamBuilder<SwitchStatus>(
              ...
              builder: (BuildContext context,
                      AsyncSnapshot<SwitchStatus> snapshot) =>
                  RaisedButton(
                child: Text((snapshot?.data is Started)
                    ? 'Stop ticker'
                    : 'Start ticker'),
                color: (snapshot?.data is Started)
                    ? const Color(0xFF7F7FFF)
                    : const Color(0xFF7FFF7F),
                onPressed: () => (snapshot?.data is Started)
...
class TickTypeSelector extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => StreamBuilder<TickTypeInstalled>(
        stream: ticker.whereState<TickTypeInstalled>(),
        builder:
            (BuildContext context, AsyncSnapshot<TickTypeInstalled> snapshot) =>
                Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Expanded(
              ...
              child: ListTile(
                ...
                leading: Radio(
                  ...
                  onChanged: (TickType value) => ticker.add(SetTickType(value)),
                ),
              ),
            ),
            Expanded(
              ...
              child: ListTile(
                title: const Text(
                  'Immutable/Constant/Singleton/Void/Enum states',
                  textScaleFactor: .75,
                ),
                leading: Radio(
