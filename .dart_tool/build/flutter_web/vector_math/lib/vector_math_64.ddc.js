define(['dart_sdk', 'packages/vector_math/hash'], function(dart_sdk, packages__vector_math__hash) {
  ...
  var JSArrayOfListOfdouble = () => (JSArrayOfListOfdouble = dart.constFn(_interceptors.JSArray$(ListOfdouble())))();
