define(['dart_sdk'], function(dart_sdk) {
  ...
  equality._UnorderedEquality$ = dart.generic((E, T) => {
    var HashMapOfE$int = () => (HashMapOfE$int = dart.constFn(collection.HashMap$(E, core.int)))();
