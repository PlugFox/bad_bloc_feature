...
let modulePaths = {
 ...
 "packages/bad_bloc_feature/main": "packages/bad_bloc_feature/main.ddc",
 "packages/bad_bloc_feature/main_web_entrypoint": "packages/bad_bloc_feature/main_web_entrypoint.ddc",
 "packages/bad_bloc_feature/ticker": "packages/bad_bloc_feature/ticker.ddc",
 ...
 "packages/rxdart/src/streams/never": "packages/rxdart/src/streams/never.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/bad_bloc_feature/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:bad_bloc_feature/main_web_entrypoint.dart") {
          // Clear static caches.
